...
for idx in range(0, len(rom), 2):
    ...
    elif operation == 0x8 and (opcode & 0xf) == 0x1: print(f'OR   V{x}, V{y}')
    elif operation == 0x8 and (opcode & 0xf) == 0x2: print(f'AND  V{x}, V{y}')
    elif operation == 0x8 and (opcode & 0xf) == 0x3: print(f'XOR  V{x}, V{y}')
    elif operation == 0x8 and (opcode & 0xf) == 0x4: print(f'ADD  V{x}, V{y}')
    elif operation == 0x8 and (opcode & 0xf) == 0x5: print(f'SUB  V{x}, V{y}')
    elif operation == 0x8 and (opcode & 0xf) == 0x6: print(f'SHR  V{x}  [, V{y}]')
    elif operation == 0x8 and (opcode & 0xf) == 0x7: print(f'SUBN V{x}, V{y}')
    ...
    elif operation == 0xf and (opcode & 0xff) == 0x15: print(f'LD   DT,  V{x}')
    elif operation == 0xf and (opcode & 0xff) == 0x18: print(f'LD   ST,  V{x}')
    elif operation == 0xf and (opcode & 0xff) == 0x1e: print(f'ADD I,   V{x}')
    elif operation == 0xf and (opcode & 0xff) == 0x29: print(f'LD   F,   V{x}')
